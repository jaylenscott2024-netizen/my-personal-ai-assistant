...
CREATE TABLE "new_UserSettings" (
    ...
    "voiceMode" TEXT NOT NULL DEFAULT 'stt',
    "realtimeVoiceProvider" TEXT NOT NULL DEFAULT 'openai-realtime',
    "realtimeVoiceModel" TEXT NOT NULL DEFAULT 'gpt-realtime',
    "realtimeVoiceToolsEnabled" BOOLEAN NOT NULL DEFAULT false,
